...
export default function Login() {
  ...
  return <AuthShell eyebrow="Secure workspace" title="Welcome back" description="Sign in to review package labels, follow analyses, and prepare clearer compliance reports.">
    ...
    <div data-testid="login-demo-hint" className="mt-5 rounded-xl border border-blue-100 bg-blue-50/70 p-3 text-xs leading-5 text-blue-800"><span className="font-semibold">Access Note:</span> Use any email address & password to sign in instantly, or use default demo credentials: <span className="font-mono font-semibold">demo@packagecheck.local / Demo123!</span></div>
